...
Litecoin is a bit of a special case, because after it launched in October 2011 it took over 10 years until MWEB was activated in May 2022. This also explains that only ~0.2%, namely [166,871 LTC](https://www.mwebexplorer.com/)  out of a circulating supply of 76,117,814 LTC are in the MimbleWimble pool, which makes using MWEB on Litecoin more "suspicious" than using shielded pools in Zcash. But I expect this situation to improve, with more mobile wallet support being rolled out, [Cake Wallet](https://cakewallet.com/) was the first one to release MWEB support just in October 2024.
